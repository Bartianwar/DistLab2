...
func (c *dataNodeServiceClient) Storage(ctx context.Context, in *DataNodeServiceStorage, opts ...grpc.CallOption) (*GreetingServiceReply, error) {
	out := new(GreetingServiceReply)
	err := c.cc.Invoke(ctx, DataNodeService_Storage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DataNodeService_Storage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataNodeServiceStorage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataNodeServiceServer).Storage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataNodeService_Storage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataNodeServiceServer).Storage(ctx, req.(*DataNodeServiceStorage))
	}
	return interceptor(ctx, in, info, handler)
}
